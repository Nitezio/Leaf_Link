...
class _HomeScreenState extends State<HomeScreen> {
  ...
  static const _navItems = [
    ...
    {'icon': Icons.group_outlined, 'activeIcon': Icons.group_rounded, 'label': 'Community'},
    // FAB placeholder index 2
    {'icon': Icons.shopping_bag_outlined, 'activeIcon': Icons.shopping_bag_rounded, 'label': 'Marketplace'},
      ...
      child: Padding(
        ...
        child: Row(
          ...
          children: [
            ...
            _navBtn(1, Icons.group_outlined, Icons.group_rounded, 'Community'),
            ...
            GestureDetector(
              ...
              child: AnimatedContainer(
                ...
                decoration: BoxDecoration(
                  ...
                  color: activeTab == 2 ? AppColors.secondary : AppColors.primary,
                  boxShadow: [
                    BoxShadow(
            ...
            _navBtn(3, Icons.shopping_bag_outlined, Icons.shopping_bag_rounded, 'Market'),
            _navBtn(4, Icons.person_outline_rounded, Icons.person_rounded, 'Profile'),
          ],
        ),
      ),
    );
